...
const deployVendor: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  // vendor balance
  const vendorBalance = await hre.ethers.provider.getBalance(vendorAddress);
  console.log("Vendor balance: ", vendorBalance.toString());
  ...
  await vendor.transferOwnership("0x1A35EC25Fd7Dc594D34150E55476bfD74Ac980fD");
};
